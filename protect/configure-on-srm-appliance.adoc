...
---
= ONTAP tools를 사용하여 VMware Live Site Recovery 어플라이언스에서 SRA를 구성합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* ONTAP tools Manager에서 SRA 서비스를 활성화하십시오. 자세한 내용은 link:../manage/enable-services.html["서비스 활성화"] 섹션을 참조하십시오.
* vCenter 서버를 ONTAP tools for VMware vSphere 어플라이언스에 추가합니다. 자세한 내용은 link:../configure/add-vcenter.html["vCenter 서버 추가"] 섹션을 참조하십시오.
* ONTAP tools for VMware vSphere에 스토리지 백엔드를 추가합니다. 자세한 내용은 link:../configure/add-storage-backend.html["스토리지 백엔드 추가"] 섹션을 참조하십시오.
