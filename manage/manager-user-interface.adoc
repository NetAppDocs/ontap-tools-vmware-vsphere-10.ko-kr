...
* 작업 모니터링 - ONTAP tools 플러그인 인터페이스와 ONTAP tools Manager 인터페이스에서 시작된 비동기 작업을 모니터링하고 디버깅할 수 있습니다. 기간별로 작업을 필터링하고, 페이지 크기를 조정하고, 오류 및 하위 작업을 포함한 작업 세부 정보를 볼 수 있습니다. 실패 상태를 클릭하면 오류 세부 정보를 볼 수 있습니다. 하위 작업이 있는 작업의 경우 행을 확장하여 설명과 상태를 볼 수 있습니다. 하위 작업의 경우 작업의 드릴다운 기능을 사용하여 세부 정보를 볼 수 있습니다.
