...
NOTE: 관리자 계정이 없으면 제한된 권한으로 사용자 지정 역할을 만들 수 있습니다. 자세한 내용은 을 link:../concepts/rbac-vcenter-use.html["VMware vSphere 10용 ONTAP 툴과 함께 vCenter Server RBAC를 사용하십시오"] 참조하십시오.
