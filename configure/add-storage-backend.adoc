...
sidebar: sidebar 
keywords:  
summary: ONTAP 도구에서 vCenter 인스턴스에 대해 로컬로 또는 클러스터 전체 검색을 위해 전역적으로 스토리지 백엔드를 추가 및 관리합니다. 
---
...
글로벌 및 로컬 스토리지 백엔드에 대한 자세한 내용은 KB 문서 https://kb.netapp.com/data-mgmt/OTV/VSC_Kbs/OTV_10_What_is_storage_backend_global_and_local_scope["OTV 10: 스토리지 백엔드 글로벌 및 로컬 범위란 무엇인가"^]를 참조하십시오.
...
.관련 정보
https://kb.netapp.com/data-mgmt/OTV/VSC_Kbs/OTV_10_What_is_storage_backend_global_and_local_scope["OTV 10: 스토리지 백엔드 글로벌 및 로컬 범위란 무엇인가"^]
