...
. 등록 후 vSphere Client의 *스토리지 공급자*에서 VASA 공급자의 이름과 상태를 확인하세요.  VASA 공급자가 온라인에 나타나 등록이 성공적으로 완료되었음을 확인해야 합니다.
...
.. vSphere Client에서 *인벤토리* > *스토리지 공급자*로 이동합니다.
.. 스토리지 백엔드에서 ONTAP 도구 9.x VASA 공급자를 선택하고 *제거*를 클릭합니다.
+
