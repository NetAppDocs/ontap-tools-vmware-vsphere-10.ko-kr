...
. 의 단계에 따라 보호 및 복구 사이트 모두에 VMware vSphere 10.1 SRA 어댑터용 ONTAP 툴을 설치합니다 link:../protect/configure-on-srm-appliance.html["VMware Live Site Recovery 어플라이언스에 SRA를 구성합니다"]
